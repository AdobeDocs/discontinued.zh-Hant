...
本檔案提供有關CX Enterprise Device Co-op生命週期結束(EOL)計畫的常見問題解答。 此計畫生效後，Adobe將在[CX Enterprise Central發行說明](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html)和[優先產品更新](https://www.adobe.com/tw/subscription/priority-product-update.html)中提供進階通知。
