...
AdTech環境中即將發生的變更預期會導致[!DNL Device Co-op]在未來幾年成為過時的解決方案。[!DNL Device Co-op] 主要由第三方Cookie所組成，且在2022年之前於[!DNL Google Chrome]封鎖第三方Cookie的[!DNL Google's]宣告將會降低[!DNL Device Co-op]的有效性。[!DNL Chrome] 有約65%的瀏覽器市佔率，而其他主要瀏覽器已實施封鎖第三方Cookie。 一旦 [!DNL Chrome] 封鎖第三方 Cookie，大部分第三方 Cookie 都會被封鎖，而 [!DNL Device Co-op] 將會被淘汰。

## Adobe 為什麼現在要終止 [!DNL Device Co-op] 註冊？

註冊即將結束，以防止因第三方Cookie的產業變動而無法達到客戶期望的風險。[!DNL Device Co-op] 您需花幾個月的時間做好準備，然後再花幾個月的時間從服務中獲取價值。 目前任何進一步的註冊，都可能導致品牌無法體驗到 [!DNL Device Co-op] 的完整價值。
...
對於[!DNL Audience Manager]和[!DNL Advertising Cloud]位使用者，[!DNL Device Co-op]的資料將無法傳輸到協力廠商圖形。[!DNL Device Co-op] 將只會為使用CDA且將[!DNL Device Co-op]切換為欄位式銜接的[!DNL Analytics Ultimate]使用者移轉資料。 所有其他解決方案都不會移轉其資料。
