...
>[!WARNING]
>
>自&#x200B;**2025年12月31日起，Cross-Device Analytics中的裝置圖表已無法使用**。 請將目前任何啟用裝置圖表的虛擬報表套裝切換為[欄位型方法](https://experienceleague.adobe.com/zh-hant/docs/analytics/components/cda/field-based-stitching)。
