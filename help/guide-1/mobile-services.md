...
此服務終止僅包含`mobilemarketing.adobe.com`處的獨立平台Adobe Mobile Services。 依賴此介面的行動版本 4 SDK 已於 2021 年 8 月 31 日停用。
...
隨著Adobe持續擴充其行動行銷功能，先前在Mobile Services中提供的功能將會在CX企業解決方案中發行，或透過Adobe Exchange主要合作夥伴提供。 這項轉變能提供更強大、更靈活的行動裝置行銷能力。
