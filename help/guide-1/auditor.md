...
[!DNL Adobe Experience Platform Auditor]是一個系統，可讓您產生報告，對您的[!DNL Adobe Experience Cloud]實作進行評分，並提供改善實作的指示。[!DNL Adobe Experience Platform Auditor] 已到期(EOL)且不再有效。
